...
class Constants:
    ...
    CONFIGURATION_TAG_WRITE_FMT = "printf \"<configuration>\\n\" > \"${{GIRAPH_CONF_DIR}}/{filename}\""
    CONFIGURATION_TAG_APPEND_FMT = "printf \"</configuration>\" >> \"${{GIRAPH_CONF_DIR}}/{filename}\"\n"


class GiraphConfigLoaderGenerator:
...
if __name__ == "__main__":
    GiraphConfigLoaderGenerator(sys.argv[1]).generate()
